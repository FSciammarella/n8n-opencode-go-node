...
class LmChatOpenCodeGo {
    description = {
        ...
        properties: [
            {
                displayName: 'You can use this node with an AI Agent, Chain, or other root nodes. When Reasoning Effort is not "none", temperature, top_p, frequency_penalty, and presence_penalty have no effect (DeepSeek API constraint).',
                name: 'notice',
                type: 'notice',
                default: '',
                displayOptions: {
            ...
            },
            {
                ...
                options: [
                        ...
                        options: [
                            {
                                name: 'None',
                                value: 'none',
                                description: 'Disable reasoning. Sends thinking: disabled to the API.',
                            },
                            {
                                name: 'Low',
                                value: 'low',
                    ...
                    },
                    {
                        ...
                        description: 'Limits the model to consider only the K most likely next tokens at each step. Lower values make output more focused and deterministic.',
                        type: 'number',
                    },
                    {
                        displayName: 'Top P',
...
exports.LmChatOpenCodeGo = LmChatOpenCodeGo;
//# sourceMappingURL=LmChatOpenCodeGo.node.js.map